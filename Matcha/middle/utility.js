...
var senderMail = function(mail, reason) {
    ...
    if (reason == "User") {
        var mailOption = {
            from: '"Matcha lherbelo" <no-reply@matcha.com>',
            to: mail,
            subject: 'Inscription à Matcha',
            text: 'Vous avez réussi votre inscription sur le site Matcha de lherbelo',
            html: '<b>Vous avez réussi votre inscription sur le site Matcha de lherbelo</b>'
        }
...
var getImage = function(req, res, callback) {
    ...
    var pos = data.split(';');
    if (log != undefined && data != undefined && (pos[0] === 'data:image/jpeg' || pos[0] === 'data:image/png')) {
