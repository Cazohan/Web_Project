...
router.get('/info/interet',function(req, res, next) {
	mymongo.getInterest(req, res, function(tagForAll) {
		req.session['interet'] = tagForAll;
		next();
	});
	...
	res.locals.session = req.session;
	res.render('partial/interet');
});

router.get('/info/photos', function(req, res, next) {
	mymongo.getMyInfo(req, res, function(myinfo) {
		req.session['myinfo'] = myinfo;
		next();
	});
	...
	res.locals.session = req.session;
	res.render('partial/mypic');
});

router.get('/info/perso', function(req, res, next) {
	mymongo.getMyInfo(req, res, function(myinfo) {
		req.session['myinfo'] = myinfo;
		next();
	});
